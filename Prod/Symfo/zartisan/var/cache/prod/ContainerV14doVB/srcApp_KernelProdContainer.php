...
class srcApp_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ApiAdviceController' => 'getApiAdviceControllerService.php',
            'App\\Controller\\ApiArtisanController' => 'getApiArtisanControllerService.php',
            'App\\Controller\\ApiJobController' => 'getApiJobControllerService.php',
            'App\\Controller\\ApiRateController' => 'getApiRateControllerService.php',
            'App\\Controller\\ApiRegionController' => 'getApiRegionControllerService.php',
            'App\\Controller\\ApiUserController' => 'getApiUserControllerService.php',
            'App\\Controller\\ExterneApiController' => 'getExterneApiControllerService.php',
            'App\\Controller\\MailController' => 'getMailControllerService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/symfony-bundles/json-request-bundle/EventListener/RequestListenerInterface.php';
            include_once $this->targetDirs[3].'/vendor/symfony-bundles/json-request-bundle/EventListener/RequestTransformerListener.php';
    ...
    {
        return $this->privates['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a-ncWxGE27', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('GG8-yB3wnK', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['security.authentication.provider.guard.main'] ?? $this->load('getSecurity_Authentication_Provider_Guard_MainService.php'));
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'SymfonyBundlesJsonRequestBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/symfony-bundles/json-request-bundle'),
