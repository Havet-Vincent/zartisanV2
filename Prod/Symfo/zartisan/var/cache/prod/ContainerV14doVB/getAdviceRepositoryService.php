...
// Returns the private 'App\Repository\AdviceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdviceRepository.php';

return $this->privates['App\\Repository\\AdviceRepository'] = new \App\Repository\AdviceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
