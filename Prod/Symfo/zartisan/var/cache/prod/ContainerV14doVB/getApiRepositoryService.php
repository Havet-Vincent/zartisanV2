...
// Returns the private 'App\Repository\ApiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ApiRepository.php';

return $this->privates['App\\Repository\\ApiRepository'] = new \App\Repository\ApiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
